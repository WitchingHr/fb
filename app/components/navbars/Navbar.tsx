...
const Navbar = () => {
  ...
  return (
    <div className="z-40 flex flex-row px-4 py-2 bg-white border-b shadow-sm lg:lg-layout-grid border-neutral-300">
      <Link href="/">
      ...
      <div className="flex flex-row items-center md:flex-1 gap-2 max-w-[680px] max-h-[40px]
        p-3 font-light rounded-full bg-neutral-100 text-neutral-500 mx-4
