  ...
  return (
    <div className="flex flex-col gap-2 p-4 bg-white dark:bg-[#242526] border dark:border-0 rounded-md shadow-sm border-neutral-300">
      ...
      <div className="flex gap-2">
        <MdHome size={20} className="text-neutral-500 dark:text-neutral-400" />
      ...
      <div className="flex gap-2">
        <MdOutlineWork size={20} className="text-neutral-500 dark:text-neutral-400" />
        <div className="font-light text-black dark:text-[#e4e6eb]">
          Works as
      ...
      <div className="flex gap-2">
        <IoSchool size={20} className="text-neutral-500 dark:text-neutral-400" />
        <div className="font-light text-black dark:text-[#e4e6eb]">
          Went to school at
      ...
      <div className="flex gap-2">
        <BsFillPersonLinesFill size={20} className="text-neutral-500 dark:text-neutral-400" />
        <div className="font-light text-black dark:text-[#e4e6eb]">
          {profile.bio}
        </div>
      </div>
